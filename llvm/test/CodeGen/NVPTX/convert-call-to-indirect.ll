...
; CHECK:       {
; CHECK-NEXT:    .local .align 1 .b8 __local_depot3[1];
...
; CHECK-NEXT:    ld.param.b8 %rd7, [retval0+4];
; CHECK-NEXT:    ld.param.b8 %rd8, [retval0+3];
; CHECK-NEXT:    ld.param.b8 %rd9, [retval0+2];
; CHECK-NEXT:    ld.param.b8 %rd10, [retval0+1];
; CHECK-NEXT:    ld.param.b8 %rd11, [retval0];
; CHECK-NEXT:    } // callseq 3
; CHECK-NEXT:    shl.b64 %rd12, %rd10, 8;
; CHECK-NEXT:    or.b64 %rd13, %rd12, %rd11;
; CHECK-NEXT:    shl.b64 %rd14, %rd9, 16;
; CHECK-NEXT:    shl.b64 %rd15, %rd8, 24;
; CHECK-NEXT:    or.b64 %rd16, %rd15, %rd14;
; CHECK-NEXT:    or.b64 %rd17, %rd16, %rd13;
; CHECK-NEXT:    shl.b64 %rd18, %rd6, 8;
; CHECK-NEXT:    or.b64 %rd19, %rd18, %rd7;
; CHECK-NEXT:    shl.b64 %rd20, %rd5, 16;
; CHECK-NEXT:    shl.b64 %rd21, %rd4, 24;
; CHECK-NEXT:    or.b64 %rd22, %rd21, %rd20;
; CHECK-NEXT:    or.b64 %rd23, %rd22, %rd19;
; CHECK-NEXT:    shl.b64 %rd24, %rd23, 32;
; CHECK-NEXT:    or.b64 %rd25, %rd24, %rd17;
; CHECK-NEXT:    st.param.b8 [func_retval0], %rd11;
; CHECK-NEXT:    shr.u64 %rd26, %rd25, 56;
; CHECK-NEXT:    st.param.b8 [func_retval0+7], %rd26;
; CHECK-NEXT:    shr.u64 %rd27, %rd25, 48;
; CHECK-NEXT:    st.param.b8 [func_retval0+6], %rd27;
; CHECK-NEXT:    shr.u64 %rd28, %rd25, 40;
; CHECK-NEXT:    st.param.b8 [func_retval0+5], %rd28;
; CHECK-NEXT:    shr.u64 %rd29, %rd25, 32;
; CHECK-NEXT:    st.param.b8 [func_retval0+4], %rd29;
; CHECK-NEXT:    shr.u64 %rd30, %rd25, 24;
; CHECK-NEXT:    st.param.b8 [func_retval0+3], %rd30;
; CHECK-NEXT:    shr.u64 %rd31, %rd25, 16;
; CHECK-NEXT:    st.param.b8 [func_retval0+2], %rd31;
; CHECK-NEXT:    shr.u64 %rd32, %rd25, 8;
; CHECK-NEXT:    st.param.b8 [func_retval0+1], %rd32;
; CHECK-NEXT:    ret;
...
; CHECK:       {
; CHECK-NEXT:    .local .align 8 .b8 __local_depot4[8];
; CHECK-NEXT:    .reg .b64 %SP;
; CHECK-NEXT:    .reg .b64 %SPL;
; CHECK-NEXT:    .reg .b64 %rd<4>;
; CHECK-EMPTY:
...
; CHECK:       {
; CHECK-NEXT:    .local .align 8 .b8 __local_depot5[8];
; CHECK-NEXT:    .reg .b64 %SP;
; CHECK-NEXT:    .reg .b64 %SPL;
; CHECK-NEXT:    .reg .b64 %rd<4>;
; CHECK-EMPTY:
